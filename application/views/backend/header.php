<header class="header">
                <div class="logo-container">
                    <a href="" class="logo">                        
                        <img src="<?=base_url();?>assets/uploads/logo4.png" width="165" height="50px"  alt="Admin- CA Exam Series" />                 
                    </a>                    
                    ...
                    <ul class="notifications">
                       <!--  <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                  <li><a tabindex="-1" href="#">CPT</a></li>
                                  <li class="dropdown-submenu">
                                    <a class="test" tabindex="-1" href="#">IPCC <span class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                      <li><a tabindex="-1" href="#">Supirior</a></li>
                                      <li><a tabindex="-1" href="#">Premium</a></li>
                                      
                                    </ul>
                                  </li>
                                  <li class="dropdown-submenu">
                                    <a class="test" tabindex="-1" href="#">Final <span class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                      <li><a tabindex="-1" href="#">Supirior</a></li>
                                      <li><a tabindex="-1" href="#">Premium</a></li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="#" class="clearfix">
                                                <figure class="image">
                                                    <img src="<?php echo base_url();?>assets/img/%21sample-user.jpg" alt="Joseph Doe Junior" class="rounded-circle" />
                                                </figure>
                                        ...
                                        <li>
                                            <a href="#" class="clearfix">
                                                <figure class="image">
                                                    <img src="<?php echo base_url();?>assets/img/%21sample-user.jpg" alt="Joseph Junior" class="rounded-circle" />
                                                </figure>
                                        ...
                                        <li>
                                            <a href="#" class="clearfix">
                                                <figure class="image">
                                                    <img src="<?php echo base_url();?>assets/img/%21sample-user.jpg" alt="Joe Junior" class="rounded-circle" />
                                                </figure>
                    ...
                    <div id="userbox" class="userbox">
                        <a href="#" data-toggle="dropdown">
                            <figure class="profile-picture">
                                <img src="<?=base_url().$login_image_url;?>" alt="Joseph Doe" class="rounded-circle" data-lock-picture="img/%21logged-user.jpg" />
                            </figure>
                        ...
                        <div class="dropdown-menu">
                            <ul class="list-unstyled mb-2">
                                ...
                                <li>
                                    <a href="<?php echo base_url();?>change_password" ><i class="fas fa-lock"></i> Change Password</a>
                                </li>
                                <!--<li>
