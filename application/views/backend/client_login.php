							  ...
							  <?=$this->session->flashdata('error_msg');?>
										...
										<div class="row">
											...
											<div class="col-sm-4 text-right">
												<button type="submit" class="btn btn-primary mt-2">Login In</button>
											</div>
										</div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <input type="text" name="name" class="form-control" placeholder="Enter your Name *" value="<?=set_value('name');?>" autocomplete="off" ><label class="error"><?php echo form_error('name'); ?></label>
                                        </div>
                                    </div>

                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <input type="email" name="name" class="form-control" placeholder="Enter Valid Email ID *" value="<?=set_value('email');?>" autocomplete="off"><label class="error"><?php echo form_error('email'); ?></label>
                                        </div>
                                    </div>

                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <input type="password" name="password" class="form-control" placeholder="Enter Valid Password " value="<?=set_value('password');?>" autocomplete="off"><label class="error"><?php echo form_error('password'); ?></label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <label class="error"><?php echo form_error('theme_type'); ?></label>
                                        </div>
                                    </div>
