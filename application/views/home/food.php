...
<div id="home" class="container-fluid p-0">
    <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
        <div class="carousel-inner">
            <?php
            $shopbooks = $this->crud_model->get_banner_info_with_clients();
            $i = 0;
            foreach ($shopbooks as $book) {
                $client = $this->crud_model->get_client_by_id($book['user_id']);
                $active_class = ($i == 0) ? 'active' : ''; 

                // Check if the theme type is 1
                if ($client['theme_type'] == 1) {
    ...
    <div id="product" class="container-fluid py-5" >
        <div class="container">
            <div class="mx-auto text-center mb-5" style="max-width: 500px;">
                ...
                <h1 class="display-5">Veg and NoN-veg</h1>
            </div>
            <div class="owl-carousel product-carousel px-5">
                <div class="pb-5">
                    <div class="product-item position-relative bg-white d-flex flex-column text-center">
                        <img class="img-fluid mb-4" src="<?php echo base_url('assets/home/plugins');?>/img/food/biriyani.jpg" alt="">
                        <h6 class="mb-3">Biriyani</h6>
                ...
                <div class="pb-5">
                    <div class="product-item position-relative bg-white d-flex flex-column text-center">
                        <img class="img-fluid mb-4" src="<?php echo base_url('assets/home/plugins');?>/img/food/burger.png" alt="">
                        <h6 class="mb-3">Burger</h6>
                        <h5 class="text-primary mb-0">110 Rs</h5>
                        <div class="btn-action d-flex justify-content-center">
                            <a class="btn bg-primary py-2 px-3" href=""><i class="bi bi-cart text-white"></i></a>
                            <a class="btn bg-secondary py-2 px-3" href=""><i class="bi bi-eye text-white"></i></a>
                        </div>
                ...
                <div class="pb-5">
                    <div class="product-item position-relative bg-white d-flex flex-column text-center">
                        <img class="img-fluid mb-4" src="<?php echo base_url('assets/home/plugins');?>/img/food/noodles.png" alt="">
                        <h6 class="mb-3">Noodels</h6>
                        <h5 class="text-primary mb-0">210 Rs</h5>
                        <div class="btn-action d-flex justify-content-center">
                            <a class="btn bg-primary py-2 px-3" href=""><i class="bi bi-cart text-white"></i></a>
                            <a class="btn bg-secondary py-2 px-3" href=""><i class="bi bi-eye text-white"></i></a>
                        </div>
                ...
                <div class="pb-5">
                    <div class="product-item position-relative bg-white d-flex flex-column text-center">
                        <img class="img-fluid mb-4" src="<?php echo base_url('assets/home/plugins');?>/img/food/pizza2.jpg" alt="" height="150px">
                        <h6 class="mb-3">Pizza</h6>
                        <h5 class="text-primary mb-0">250 Rs</h5>
                        <div class="btn-action d-flex justify-content-center">
                            <a class="btn bg-primary py-2 px-3" href=""><i class="bi bi-cart text-white"></i></a>
                            <a class="btn bg-secondary py-2 px-3" href=""><i class="bi bi-eye text-white"></i></a>
                ...
                <div class="pb-5">
                    <div class="product-item position-relative bg-white d-flex flex-column text-center">
                        <img class="img-fluid mb-4" src="<?php echo base_url('assets/home/plugins');?>/img/food/cheese-burger.png" alt="">
                        <h6 class="mb-3">Cheese Burger</h6>
                        <h5 class="text-primary mb-0">290 Rs</h5>
                        <div class="btn-action d-flex justify-content-center">
                            <a class="btn bg-primary py-2 px-3" href=""><i class="bi bi-cart text-white"></i></a>
                            <a class="btn bg-secondary py-2 px-3" href=""><i class="bi bi-eye text-white"></i></a>
                        </div>
                ...
                <div class="owl-carousel testimonial-carousel p-5">
                    ...
                    foreach ($testomonial as $row) {
                        if ($row['theme_type'] == 1) {
                            ...
                            <h4 class="text-dark mb-0"><?= $row['first_namename']; ?></h4>
                        </div>
                            <?php
                        }
                    }
...
<!-- Testimonial End -->
    ...
    <div class="container" >
        <div class="row gx-5">
            ...
            $about = $this->crud_model->get_about_image_by_theme(1);
            $i = 0;
