    ...
    <div class="container-fluid py-5" id="product">
        <div class="container">
            <div class="mx-auto text-center mb-5" style="max-width: 500px;">
                <h6 class="text-primary text-uppercase">Sales Places</h6>
                <h1 class="display-5">All Real-estate Place</h1>
            </div>
            <div class="owl-carousel product-carousel  product-carousel-2 px-5">
                <div class="pb-5">
                    <div class="product-item position-relative bg-white d-flex flex-column text-center">
                        <img class="img-fluid mb-4" src="<?php echo base_url('assets/home/plugins');?>/img/rel/sales6.jpg" alt="">
                        <h6 class="mb-3">Interiro</h6>
                        <h5 class="text-primary mb-0">250000 Rs</h5>
                ...
                <div class="pb-5">
                    <div class="product-item position-relative bg-white d-flex flex-column text-center">
                        <img class="img-fluid mb-4" src="<?php echo base_url('assets/home/plugins');?>/img/rel/sales2.jpg" alt="">
                        <h6 class="mb-3">Home</h6>
                        <h5 class="text-primary mb-0">350000 Rs</h5>
                        <div class="btn-action d-flex justify-content-center">
                            <a class="btn bg-primary py-2 px-3" href=""><i class="bi bi-cart text-white"></i></a>
                            <a class="btn bg-secondary py-2 px-3" href=""><i class="bi bi-eye text-white"></i></a>
                        </div>
                ...
                <div class="pb-5">
                    <div class="product-item position-relative bg-white d-flex flex-column text-center">
                        <img class="img-fluid mb-4" src="<?php echo base_url('assets/home/plugins');?>/img/rel/sales3.jpg" alt="" >
                        <h6 class="mb-3">Hall</h6>
                        <h5 class="text-primary mb-0">550000 Rs</h5>
                        <div class="btn-action d-flex justify-content-center">
                            <a class="btn bg-primary py-2 px-3" href=""><i class="bi bi-cart text-white"></i></a>
                            <a class="btn bg-secondary py-2 px-3" href=""><i class="bi bi-eye text-white"></i></a>
                        </div>
                ...
                <div class="pb-5">
                    <div class="product-item position-relative bg-white d-flex flex-column text-center">
                        <img class="img-fluid mb-4" src="<?php echo base_url('assets/home/plugins');?>/img/rel/sales4.jpg" alt="" >
                ...
                <div class="pb-5">
                    <div class="product-item position-relative bg-white d-flex flex-column text-center">
                        <img class="img-fluid mb-4" src="<?php echo base_url('assets/home/plugins');?>/img/rel/sales5.jpg" alt="" >
                        <h6 class="mb-3">Bed room</h6>
                        <h5 class="text-primary mb-0">520000 Rs</h5>
                        <div class="btn-action d-flex justify-content-center">
                            <a class="btn bg-primary py-2 px-3" href=""><i class="bi bi-cart text-white"></i></a>
                            <a class="btn bg-secondary py-2 px-3" href=""><i class="bi bi-eye text-white"></i></a>
                        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-7">
                    <div class="owl-carousel testimonial-carousel p-5">
                          <?php
                    $testomonial = $this->crud_model->get_testomonial_info_by_theme_type(4);
    ...
    <div class="container py-5">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-7">
                <div class="owl-carousel testimonial-carousel p-5">
                    <?php
                    $teams = $this->crud_model->get_team_by_theme(4);
