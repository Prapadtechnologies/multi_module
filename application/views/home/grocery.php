...
<div class="container-fluid p-0">
    <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
        <div class="carousel-inner">
            <?php
            $shopbooks = $this->crud_model->get_shopimages_theme_type(2);
            $i = 0;
            ...
            <div class="row justify-content-center">
                <div class="col-lg-7">
                    <div class="owl-carousel testimonial-carousel p-5">
                        <?php
                    $testomonial = $this->crud_model->get_testomonial_info_by_theme_type(2);
    ...
    <div class="container">
        <div class="row gx-5">
            ...
            $about = $this->crud_model->get_about_image_by_theme(2);
            $i = 0;
    ...
    <div class="container py-5">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-7">
                <div class="owl-carousel testimonial-carousel p-5">
                    <?php
                    $teams = $this->crud_model->get_team_by_theme(2);
