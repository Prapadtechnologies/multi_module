    ...
    if($id!=''){
        ...
        if($this->input->post()){
           ...
           if($id==''){
            ...
            if($res>0){
                $this->session->set_flashdata('success_message',"Course Saved Successfully");
            }else{
                $this->session->set_flashdata('error_message',"Course Not Saved");
            }
        }elseif($id!=''){
                $where['id']=$id;
            ...
            if($res>0){
                ...
                $this->session->set_flashdata('error_message',"Course Not Updated");
            }
            }
            redirect('courses');
        }*/
